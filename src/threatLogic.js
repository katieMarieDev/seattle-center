...
export const THREAT_LEVELS = {
  ...
  DANGER: {
    ...
    description: "There's something going on nearby tonight. Parking near the venue might be tight.",
  ...
  SAFE: {
    ...
    description: "It's quiet out there. Parking is easy and your favorite restaurant has tables.",
